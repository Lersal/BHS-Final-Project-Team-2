  ...
  return (
    <div className="border border-gray-300 m-20 flex md:flex-shrink-0">
        ...
        <form action="login" method="post">
          ...
          <div className="mb-5 flex flex-col">
            <label className="text-xl" htmlFor="email">
              {" "}
              Alamat Email <span className="text-gray-400">*</span>
            </label>
            <input
              className="border-b border-black w-auto py-2 px-4 mb-3 placeholder:w-auto bg-gray-100"
              type="email"
              id="email"
          ...
          <div className="mb-5 flex flex-col">
            <label htmlFor="password" className="text-xl">
              Kata Sandi <span className="text-gray-400">*</span>
            </label>
            <input
              className="border-b border-black w-auto py-2 px-4 mb-2 bg-gray-100"
              type="password"
              id="password"
              required
            />
            <p className="text-sm text-gray-400 mb-4">
              {" "}
              kata sandi terdiri dari 8 karakter
            </p>
          </div>
          {/* ketentuan & kebijakan */}
          ...
          <div className="mt-5 flex flex-col">
            <button className=" bg-black text-white text-xl font-bold py-2 px-10 mb-7 w-full">
              {" "}
              <a href="login.php" /> MASUK{" "}
            </button>
            {/* lupa kata sandi */}
      ...
      <div className="w-2/4 my-5 ">
        ...
        <p className="text-base mx-5 mt-6 mb-14 ">
          {" "}
          Jika Anda membuat akun, Anda bisa mendapatkan layanan yang
          dipersonalisasikan seperti melihat riwayat pembelian dan mendapatkan
          kupon diskon dengan keanggotaan Anda. Daftar hari ini, gratis!
        </p>
        <Link
          to="/Register"
          className="border border-black py-2 px-10 mx-6 w-full bg-black text-white text-xl font-bold"
        >
          {" "}
          DAFTAR
        </Link>
